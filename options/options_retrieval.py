...
class  opts_pku_part1_cross_subject():
  ...
  def __init__(self):
    ...
    # feeder
    self.train_feeder_args = {
      "data_path": data_path + "/pku_v1/xsub/train_position.npy",
    ...
    self.test_feeder_args = {
      ...
      'data_path': data_path + "/pku_v1/xsub/val_position.npy",
...
class  opts_pku_part2_cross_subject():
  ...
  def __init__(self):
    ...
    # feeder
    self.train_feeder_args = {
      "data_path": data_path + "/pku_v2/xsub/train_position.npy",
    ...
    self.test_feeder_args = {
      ...
      'data_path': data_path + "/pku_v2/xsub/val_position.npy",
