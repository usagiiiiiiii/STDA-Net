...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', default='../data/nturgbd_raw/ntu10/')
    parser.add_argument('--ignored_sample_path',
                        default='../data/nturgbd_raw/samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='../data/NTU-RGB-D-60-10/')
    benchmark = ['xsub', 'xview']

    #parser.add_argument('--data_path', default='/data/Disk_A/jiannan/ST-MGN/data/nturgbd_raw_120/nturgb+d_skeletons/')
    #parser.add_argument('--ignored_sample_path',
     #                   default='/data/Disk_A/jiannan/ST-MGN/data/nturgbd_raw_120/samples_with_missing_skeletons.txt')
    #parser.add_argument('--out_folder', default='/data/Disk_A/jiannan/ST-MGN/data/NTU-RGB-D-120-AGCN/')
